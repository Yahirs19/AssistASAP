        ...
        <div className="bg-white">
            ...
            <div className="mt-5 pl-10 pr-10 pb-6">
              <button
                ...
                className="w-full rounded-md border border-transparent bg-blue-500 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-50"
              >
                Guardar orden
              </button>
            </div>
